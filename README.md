...
| بخش | توضیح |
|---|---|
| **درخت تجهیزات** | سلسله‌مراتب تا **شش سطح** (دکل ← سیستم ← تجهیز ← زیرتجهیز ← قطعه)، با کد فنی و مدل هر آیتم و شمارش زیرمجموعه‌ها. قابل ایمپورت از فایل‌های اکسل موجود |
| **برنامه‌های PM** | زمان‌بندی روزانه / هفتگی / ماهانه بر پایه‌ی **تقویم شمسی**، با تولید خودکار شبانه‌ی دستور کار |
| **دستور کار (WO)** | چرخه‌ی کامل با شماره‌ی یکتا: صدور، اجرا، چک‌لیست اینلاین، بستن — با قفل «دلیل تأخیر» روی کارهای عقب‌افتاده، و کپی تکی/گروهی |
| **گزارش خرابی** | ثبت خرابی با محاسبه‌ی خودکار مدت توقف، قطعات مصرفی، شرح رفع و اقدام پیشگیرانه؛ به‌علاوه‌ی تاریخچه‌ی رفع‌شده‌ها |
| **کارهای Unplan** | کار برنامه‌ریزی‌نشده، جدا از چرخه‌ی PM ولی در همان گزارش‌ها |
| **گزارش روزانه** | تولید از کارهای PM به تفکیک دپارتمان، قفل‌شدن در لحظه‌ی ثبت، بایگانی در پوشه‌های سال/ماه شمسی، خروجی چاپی و ZIP |

### گزارش و شاخص‌ها

**گزارش KPI** شاخص‌های استاندارد نت را می‌دهد: **MTBF**، **MTTR**،
**Availability**، تعداد خرابی، ساعت توقف و تعداد تجهیزات دارای خرابی —
با فیلتر دکل، دپارتمان و بازه‌ی زمانی تا ۱۲ ماه.

روند دسترس‌پذیری ناوگان با آستانه‌های رنگی نمایش داده می‌شود
(سبز ≥۹۸٪ · زرد ۹۵–۹۸٪ · قرمز <۹۵٪)، در کنار نمودارهای ماهانه‌ی
تعداد خرابی و ساعت توقف.

**خروجی اکسل** از هر فهرستی گرفته می‌شود. خروجی چک‌لیست PM هر دپارتمان
را در شیت جدا می‌گذارد، آیتم‌ها را با ✓ / N/A علامت می‌زند و سررسید و
دلیل تأخیر را هم می‌آورد. بازه‌ها: امروز، هفته‌ی جاری، ماه جاری، بازه‌ی
دلخواه، همه‌ی کارهای باز، یا اکسپورت کلی — همه شمسی.

### زنجیره‌ی تأمین

خط خرید به‌صورت یک **مسیر مرحله‌به‌مرحله** دیده می‌شود و سامانه نشان
می‌دهد کار دقیقاً کجا معطل مانده: منتظر خرید ← منتظر تأیید سفارش ←
منتظر رسید ← منتظر فاکتور ← فاکتور مغایر.

درخواست کالا · سفارش خرید · رسید و بازرسی · فاکتور و پرداخت ·
تأمین‌کنندگان · پرونده‌ی واردات · موجودی انبار · کالای در راه · کاردکس ·
کاتالوگ کالا · قطعات تعمیرپذیر · گارانتی · دفتر هزینه · بودجه · تنخواه ·
نرخ ارز — با اتصال به API انبار سازمان.

### اداری و کارکنان

نامه‌نگاری اداری با سربرگ، گردش کار افقی و امضای اسکن‌شده · صندوق
دریافتی · کتابخانه‌ی اسناد · مرخصی · درخواست سفر · فیش حقوقی · تیکت
پشتیبانی · موتور تأیید چندمرحله‌ای با شرط مبلغی.

### زیرساخت

- **دوزبانه** — فارسی راست‌چین و English چپ‌چین، با تعویض آنی؛ شامل
  خروجی‌های چاپی و PDF
- **دسترسی نقش‌محور** — ادمین / مدیر / کاربر، به‌علاوه‌ی **جداسازی داده بر
  اساس دکل**: کاربر هر دکل فقط داده‌ی همان دکل را می‌بیند
- **کارتابل و تصمیم‌های در انتظار** — هر کاربر دقیقاً می‌داند چه چیزی
  منتظر اوست
- **برندینگ** — نام و لوگوی شرکت از خود پنل تنظیم می‌شود و روی صفحه‌ی
  ورود، سایدبار و سربرگ نامه‌ها می‌نشیند (۲۴ تنظیم در ۸ بخش)
- **بکاپ خودکار شبانه** با `pg_dump`، و بازیابی از داخل پنل
- **اعلان‌ها** روی تلگرام، بله و ایمیل
- **دستیار هوشمند** برای پرسیدن وضعیت تجهیزات، دستور کارها، خرابی‌ها،
  انبار و نامه‌ها به زبان طبیعی — فقط می‌خواند، چیزی ثبت یا ارسال نمی‌کند
- **پوسته‌ی دسکتاپ** (Tauri) در کنار نسخه‌ی مرورگر و PWA
